...
function demoReducer(state={status: "succeeded", loading: false}, action){
    switch (action.type) {
...
// the parts- each of these will receive a part of the state and are responsible for returning an updated part
// return the state itself if no changes are made
